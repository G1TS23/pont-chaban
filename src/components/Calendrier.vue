<template>
    <div class="calendar">
        <div class="view">
            ...
            <div class="day" v-for="i in (getDaysInMonth() + firstDay - 1)" :key="i" @click="returnDayToDisplay(i)">
                ...
                <div v-else class="show" :class="{  'today' : i - firstDay + 1 === today.getDate() && today.getFullYear() === year && today.getMonth() === month,
                                        ...
                                        'highlight' : i === day + firstDay -1,
                                        'highlight-today': i - firstDay + 1 === today.getDate() && today.getFullYear() === year && today.getMonth() === month && i === day + firstDay -1}">
                        {{ i - firstDay + 1 }}
                </div>
                <div v-if="hasClosing(i - firstDay + 1) && i >= firstDay" class="dot">.</div>
                <div v-else class="dot-hidden">.</div>
...
export default {
    ...
    updated(){
        ...
        //this.returnDayToDisplay(this.day);
    },
    data(){
        return{
            today: new Date(),
    ...
    methods: {
        ...
        returnDayToDisplay(i){
            ...
            this.$emit('clikOnDay', dayToDisplay, i - this.firstDay + 1);
        },
